...
var SHEET_SCHEMA_REGISTRY = {
  ...
  Sessions: { required: ['token','no_hp','member_id','otp','otp_expires_at','otp_used','session_expires_at','created_at'], optional: ['otp_failed_attempts','otp_locked_at','otp_plain'], primary_id: 'token', unique: true },
